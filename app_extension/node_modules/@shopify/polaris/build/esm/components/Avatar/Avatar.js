...
function Avatar({
  ...
  const className = classNames(styles.Avatar, size && styles[variationName('size', size)], hasImage && status === Status.Loaded && styles.imageHasLoaded, !customer && !source && styles[variationName('style', styleClass(nameString))]);
