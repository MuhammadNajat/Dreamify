@charset "UTF-8";
:root { --polaris-version-number: '12.1.1'; }
...
.Polaris-Button:focus:not(.Polaris-Button--primary):not(.Polaris-Button--plain):not(.Polaris-Button--tertiary), .Polaris-Button:focus-visible:not(.Polaris-Button--primary):not(.Polaris-Button--plain):not(.Polaris-Button--tertiary) { box-shadow: var(--pc-button-shadow); }
...
.Polaris-Button--monochrome.Polaris-Button--plain.Polaris-Button--disabled { color: var(--p-color-text-disabled); }
...
[data-buttongroup-variant='segmented'] > :not(:first-child) .Polaris-Button.Polaris-Button--primary { margin-left: calc(var(--p-space-025)*-1); }
...
.Polaris-TextField--toneMagic > .Polaris-TextField__Input { color: var(--p-color-text-magic); }

.Polaris-TextField--toneMagic > .Polaris-TextField__Backdrop { background-color: var(--p-color-bg-surface-magic); border-color: var(--p-color-border-magic-secondary); }

.Polaris-TextField--toneMagic:not(.Polaris-TextField--disabled):not(.Polaris-TextField--error):not(.Polaris-TextField--readOnly) > .Polaris-TextField__Input:hover:not(:focus-visible) ~ .Polaris-TextField__Backdrop { background-color: var(--p-color-bg-surface-magic-hover); border-color: var(--p-color-border-magic-secondary-hover); }

.Polaris-TextField--toneMagic.Polaris-TextField--focus > .Polaris-TextField__Input, .Polaris-TextField--toneMagic.Polaris-TextField--focus > .Polaris-TextField__VerticalContent, .Polaris-TextField--toneMagic.Polaris-TextField:focus-within > .Polaris-TextField__Input, .Polaris-TextField--toneMagic.Polaris-TextField__Input:focus-visible { color: var(--p-color-text); }
...
.Polaris-TextField__Segment { background: var(--p-color-bg-fill-tertiary); border-radius: var(--p-border-radius-100); display: flex; flex: 1 1; justify-content: center; align-items: center; -webkit-appearance: none; appearance: none; border: none; }
...
.Polaris-TextField__Segment:first-child { margin-bottom: 0; border-bottom-left-radius: 0; border-bottom-right-radius: 0; }
...
.Polaris-Choice--toneMagic > .Polaris-Choice__Label { color: var(--p-color-text-magic); }
...
.Polaris-Checkbox__Input:checked ~ .Polaris-Checkbox__Icon svg, .Polaris-Checkbox__Input.Polaris-Checkbox__Input--indeterminate ~ .Polaris-Checkbox__Icon svg { fill: var(--p-color-text-brand-on-bg-fill); }
...
.Polaris-Checkbox__Input:disabled + .Polaris-Checkbox__Backdrop { border-color: var(--p-color-border-disabled); border-color: transparent; background-color: var(--p-color-checkbox-bg-surface-disabled); box-shadow: none; }
...
.Polaris-Checkbox__Input:disabled ~ .Polaris-Checkbox__Icon svg { color: var(--p-color-checkbox-icon-disabled); }
...
.Polaris-Checkbox__Input.Polaris-Checkbox--toneMagic + .Polaris-Checkbox__Backdrop { background-color: var(--p-color-bg-surface-magic); box-shadow: inset 0 0 0 var(--p-border-width-0165) var(--p-color-border-magic-secondary); }

.Polaris-Checkbox__ChoiceLabel:hover .Polaris-Checkbox__Input.Polaris-Checkbox--toneMagic + .Polaris-Checkbox__Backdrop { background-color: var(--p-color-bg-surface-magic-hover); box-shadow: inset 0 0 0 var(--p-border-width-0165) var(--p-color-border-magic-secondary-hover); }

.Polaris-Checkbox__Input.Polaris-Checkbox--toneMagic:checked + .Polaris-Checkbox__Backdrop, .Polaris-Checkbox__Input.Polaris-Checkbox--toneMagic.Polaris-Checkbox__Input--indeterminate + .Polaris-Checkbox__Backdrop { border-color: var(--p-color-bg-fill-magic); background-color: var(--p-color-bg-fill-magic); box-shadow: inset 0 0 0 var(--p-space-800) var(--p-color-bg-fill-magic); }
...
.Polaris-Checkbox__Icon svg { color: var(--p-color-text-brand-on-bg-fill); position: absolute; top: 0; left: 0; bottom: 0; right: 0; }

@media (-ms-high-contrast: active) { .Polaris-Checkbox__Icon { fill: windowText; } }

.Polaris-Checkbox--error .Polaris-Checkbox__Icon svg { color: var(--p-color-text-critical-on-bg-fill); }
...
.Polaris-Banner__DismissIcon { display: flex; }
...
.Polaris-RadioButton__Input.Polaris-RadioButton--toneMagic:checked:not([disabled]) + .Polaris-RadioButton__Backdrop, .Polaris-RadioButton__ChoiceLabel:hover .Polaris-RadioButton__Input.Polaris-RadioButton--toneMagic:checked:not([disabled]) + .Polaris-RadioButton__Backdrop { background-color: var(--p-color-bg-fill-magic); border-color: var(--p-color-bg-fill-magic); }

.Polaris-RadioButton__Input.Polaris-RadioButton--toneMagic:checked:not([disabled]) + .Polaris-RadioButton__Backdrop::before, .Polaris-RadioButton__ChoiceLabel:hover .Polaris-RadioButton__Input.Polaris-RadioButton--toneMagic:checked:not([disabled]) + .Polaris-RadioButton__Backdrop::before { background-color: var(--p-color-text-magic-on-bg-fill); }
...
.Polaris-Filters-SearchField { --pc-indexfilter-search-padding-inline: var(--p-space-150); position: relative; display: flex; padding-block: var(--p-space-025); margin-left: var(--p-space-050); }
...
.Polaris-Filters-SearchField__Suffix { position: absolute; top: 50%; right: var(--pc-indexfilter-search-padding-inline); transform: translateY(-50%); }

.Polaris-Filters-SearchField__ClearButton { background: none; border: none; opacity: 0; transition: opacity var(--p-motion-duration-150) var(--p-motion-ease-in-out); cursor: pointer; padding: 0; }

.Polaris-Filters-SearchField__ClearButton--focused { opacity: 1; pointer-events: auto; }

.Polaris-Filters-SearchField__Spinner { width: var(--p-space-500); }

.Polaris-Filters-SearchField__Spinner svg { display: block; }
...
.Polaris-IndexTable__Table--unselectable.Polaris-IndexTable__Table--sticky .Polaris-IndexTable__TableRow--subheader .Polaris-IndexTable__TableCell:first-child { background-color: var(--p-color-bg-surface-secondary); }

.Polaris-IndexTable__Table--unselectable .Polaris-IndexTable__TableRow--hovered:not(.Polaris-IndexTable__TableRow--disabled) .Polaris-IndexTable__TableCell:first-child { background-color: var(--p-color-bg-surface-hover); }
...
.Polaris-SkeletonThumbnail { --pc-skeleton-thumbnail-extra-small-size: 1.5rem; --pc-skeleton-thumbnail-small-size: 2.5rem; --pc-skeleton-thumbnail-medium-size: 3.75rem; --pc-skeleton-thumbnail-large-size: 5rem; display: flex; background-color: var(--p-color-bg-fill-tertiary); border-radius: var(--p-border-radius-200); }
