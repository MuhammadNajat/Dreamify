...
export declare function SearchField({ value, focused, active, placeholder, onChange, onFocus, onBlur, onCancel, showFocusBorder, }: SearchFieldProps): React.JSX.Element;
