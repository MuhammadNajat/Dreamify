...
type Description = string | React.ReactElement | (string | React.ReactElement)[];
interface Item {
...
export declare function ExceptionList({ items: itemsList }: ExceptionListProps): React.JSX.Element;
export {};
