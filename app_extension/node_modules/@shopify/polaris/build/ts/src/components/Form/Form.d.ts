...
export declare function Form({ acceptCharset, action, autoComplete, children, encType, implicitSubmit, method, name, noValidate, preventDefault, target, onSubmit, }: FormProps): React.JSX.Element;
export {};
