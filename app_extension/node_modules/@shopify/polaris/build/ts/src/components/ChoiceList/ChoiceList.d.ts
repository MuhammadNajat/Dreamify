...
export declare function ChoiceList({ title, titleHidden, allowMultiple, choices, selected, onChange, error, disabled, name: nameProp, tone, }: ChoiceListProps): React.JSX.Element;
export {};
