 ...
 * }
 */
export declare function useDeepCallback<T extends Function>(callback: T, dependencies: Parameters<typeof useDeepCompareRef>[0], customCompare?: Parameters<typeof useDeepCompareRef>[1]): T;
