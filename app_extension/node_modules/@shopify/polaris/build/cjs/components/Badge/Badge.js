...
function Badge({
  ...
  const className = css.classNames(Badge$1.default.Badge, tone && Badge$1.default[css.variationName('tone', tone)], size && size !== DEFAULT_SIZE && Badge$1.default[css.variationName('size', size)], withinFilter && Badge$1.default.withinFilter);
  const accessibilityLabel = toneAndProgressLabelOverride ? toneAndProgressLabelOverride : utils.getDefaultAccessibilityLabel(i18n, progress, tone);
