...
export async function deployConfirmationPrompt({ summary: { appTitle, question, identifiers, toCreate, dashboardOnly }, release, apiKey, token, }) {
    const { infoTable, removesExtension } = await buildInfoPrompt(apiKey, token, identifiers, toCreate, dashboardOnly);
...
async function getInfoBreakdown(apiKey, token, localRegistration, toCreate, dashboardOnly) {
...
async function buildInfoPrompt(apiKey, token, localRegistration, toCreate, dashboardOnly) {
