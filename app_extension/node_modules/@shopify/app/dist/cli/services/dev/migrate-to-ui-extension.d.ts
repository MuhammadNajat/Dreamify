...
export declare function getUIExtensionsToMigrate(localSources: LocalSource[], remoteSources: RemoteSource[], identifiers: IdentifiersExtensions): LocalRemoteSource[];
