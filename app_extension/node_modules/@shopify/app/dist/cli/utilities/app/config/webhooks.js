...
export function fakedWebhookSubscriptionsMutation(subscriptions) {
...
const generateSubscriptionKey = (topic, endpoint) => `${topic}::${endpoint}`;
...
export function validateInnerSubscriptions({ endpoint, subscriptions = [], ...schema }) {
